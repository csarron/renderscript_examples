...
const float MIN_HARRIS_SCORE = 16.118095651f;
const float MAX_HARRIS_SCORE = 35.4938722213f;
const float HARRIS_SCORE_DIV = 13.1607628254f;

const int BLOCK_SIZE = 7;
const float HARRIS_K = 0.04f;

uchar calculateHarrisScore(uchar * v_in, int row_stride) {
